...
/**
 * Test class for {@link Z80IfBlockParser}.
 *
 * @author Francis Gagné
 */
public class Z80IfBlockParserTest {
    ...
    private static void parseIfBlock(@Nonnull String code, @Nonnull Matcher<Object> blockParseErrorMatcher, int numberOfChildNodes) {
        SourceNode node = Z80Parser.INSTANCE.parse(new Document(code));
        ...
        for (int i = 0; i < childNodes.size(); i++) {
            ...
            assertThat(childNode, hasType((i & 1) == 0 ? Z80BlockDirectiveLine.class : SimpleCompositeSourceNode.class));
        }
    }

    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses a complete <code>IF</code> block that ends with an <code>ENDIF</code>
     * directive.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses a complete <code>IF</code> block with an <code>ELSE</code> clause.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses a complete <code>IF</code> block with two <code>ELSE</code> clauses.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses a complete <code>IF</code> block with an <code>ELSEIF</code> clause
    ...
    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses a complete <code>IF</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses an incomplete <code>IF</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80IfBlockParser} correctly parses an incomplete <code>IF</code> block with an <code>ELSE</code> clause.
     */
    @Test
