...
import static org.reasm.z80.source.BlockParserTestsCommon.COMPLETE_BLOCK;
import static org.reasm.z80.source.BlockParserTestsCommon.INCOMPLETE_BLOCK;
...
public class BlockParsersTest {
    ...
    private static void parsePhaseBlock(@Nonnull String code, @Nonnull Matcher<? super ParseError> blockParseErrorMatcher,
            @CheckForNull Matcher<? super SourceNode> thirdChildNodeMatcher) {
        parseBasicBlock(code, PhaseBlock.class, SimpleCompositeSourceNode.class, blockParseErrorMatcher, thirdChildNodeMatcher);
    }
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>DO</code> block.
     */
    @Test
    public void parseCompleteDoBlock() {
        parseDoBlock(" DO\n NOP\n UNTIL", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>FOR</code> block.
     */
    @Test
    public void parseCompleteForBlock() {
        parseForBlock(" FOR\n NOP\n NEXT", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>MACRO</code> block.
     */
    @Test
    public void parseCompleteMacroBlock() {
        parseMacroBlock(" MACRO\n NOP\n ENDM", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>NAMESPACE</code> block.
     */
    @Test
    public void parseCompleteNamespaceBlock() {
        parseNamespaceBlock(" NAMESPACE\n NOP\n ENDNS", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>PHASE</code> block.
     */
    @Test
    public void parseCompletePhaseBlock() {
        parsePhaseBlock(" PHASE\n NOP\n DEPHASE", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>REPT</code> block.
     */
    @Test
    public void parseCompleteReptBlock() {
        parseReptBlock(" REPT\n NOP\n ENDR", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>TRANSFORM</code> block.
     */
    @Test
    public void parseCompleteTransformBlock() {
        parseTransformBlock(" TRANSFORM\n NOP\n ENDTRANSFORM", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses a complete <code>WHILE</code> block.
     */
    @Test
    public void parseCompleteWhileBlock() {
        parseWhileBlock(" WHILE\n NOP\n ENDW", COMPLETE_BLOCK, hasType(Z80BlockDirectiveLine.class));
    }

    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>DO</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>FOR</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>MACRO</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>NAMESPACE</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>PHASE</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>REPT</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>TRANSFORM</code> block.
     */
    @Test
    ...
    /**
     * Asserts that {@link Z80Parser} correctly parses an incomplete <code>WHILE</code> block.
     */
    @Test
