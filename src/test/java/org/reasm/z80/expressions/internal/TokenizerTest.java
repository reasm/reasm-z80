...
import org.reasm.z80.testhelpers.TokenMatcher;
...
public class TokenizerTest {
    ...
    @SuiteClasses({ TokenizerTest.class, TokenizeTest.class })
    ...
    public static class TokenizeTest {
        ...
        static {
            ...
            final TokenMatcher hex3 = new TokenMatcher(TokenType.HEXADECIMAL_INTEGER, 0, 3);
            ...
            addDataItem("0H", new TokenMatcher(TokenType.HEXADECIMAL_INTEGER, 0, 2));
            addDataItem("0@H", invalid3);
            addDataItem("0AH", hex3);
            addDataItem("0FH", hex3);
            addDataItem("0123456789ABCDEFabcdefH", new TokenMatcher(TokenType.HEXADECIMAL_INTEGER, 0, 23));
            addDataItem("0GH", invalid3);
            addDataItem("0FGH", invalid4);
            addDataItem("0aH", hex3);
            addDataItem("0fH", hex3);
            addDataItem("0gH", invalid3);
            addDataItem("0fgH", invalid4);
            ...
            addDataItem("0B", bin2);
            addDataItem("1B", bin2);
            addDataItem("1100100101B", new TokenMatcher(TokenType.BINARY_INTEGER, 0, 11));
            addDataItem("2B", invalid2);
            addDataItem("0AB", invalid3);
            addDataItem("012B", invalid4);
            addDataItem("0b", bin2);
            addDataItem("0.", real2);
            ...
            addDataItem("0%0", dec1, operator_1_2, new TokenMatcher(TokenType.DECIMAL_INTEGER, 2, 3));
            addDataItem("0E+0", invalid2, new TokenMatcher(TokenType.PLUS_OR_MINUS_SEQUENCE, 2, 3), new TokenMatcher(
                    TokenType.DECIMAL_INTEGER, 3, 4));
            addDataItem("<!", operator1, operator_1_2);
            addDataItem(">!", operator1, operator_1_2);
