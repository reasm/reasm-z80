...
public class ExpressionParserTest {
    ...
    private static final Object[][] TEST_DATA_ARRAY = new Object[][] {
            ...
            { new DataItem("0B", 2, VALUE_UINT_0) },

            // A short binary integer literal followed by a closing parenthesis
            { new DataItem("0B)", 2, VALUE_UINT_0) },

            // A long binary integer literal
            { new DataItem("111010110111100110100010101B", 28, VALUE_UINT_123456789) },

            // A long binary integer literal followed by a closing parenthesis
            { new DataItem("111010110111100110100010101B)", 28, VALUE_UINT_123456789) },

            // A longer binary integer literal
            { new DataItem("1000100100010000100001111010001111101111010011000000100010101B", 62, VALUE_UINT_1234567890123456789) },

            // An almost-overflowing binary integer literal
            { new DataItem("1111111111111111111111111111111111111111111111111111111111111111B", 65, VALUE_UINT_18446744073709551615) },

            // An overflowing binary integer literal
            { new DataItem("1001111110010000011011001100100100011010111110110010011011000101101110001110011000000100010101B", 95,
            ...
            { new DataItem("0H", 2, VALUE_UINT_0) },
            ...
            { new DataItem("75BCD15H", 8, VALUE_UINT_123456789) },
            ...
            { new DataItem("112210F47DE98115H", 17, VALUE_UINT_1234567890123456789) },

            // An almost-overflowing hexadecimal integer literal
            { new DataItem("0FFFFFFFFFFFFFFFFH", 18, VALUE_UINT_18446744073709551615) },

            // An overflowing hexadecimal integer literal
            { new DataItem("27E41B3246BEC9B16E398115H", 25, VALUE_UINT_5097733592125636885, new OverflowInLiteralWarningMessage(
                    "27E41B3246BEC9B16E398115")) },

            // An overflowing hexadecimal integer literal (parse with assemblyMessageConsumer == null)
            { new DataItem("27E41B3246BEC9B16E398115H", 25, VALUE_UINT_5097733592125636885, DONT_CHECK_ASSEMBLY_MESSAGES) },
